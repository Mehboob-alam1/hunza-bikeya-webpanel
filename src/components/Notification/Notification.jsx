...
const Notification = ({ onClose }) => {
  return (
    <>
      <div>
        <div className="relative z-50 w-[100%]  h-[100vh] top-0 flex justify-center items-center modelOpacity overflow-y-scroll pt-[18rem]  ">
          {/* Modal content */}
          <div className=" bg-white rounded shadow w-[45%] h-[132vh] absolute right-0 top-0  ">
            {/* Modal header */}
